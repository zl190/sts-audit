"""
Online Bookstore Order System — H-level version (high coupling)
All logic (UI, discount, persistence, notification) crammed into one class.
"""
...
class OrderProcessor:
    ...
    def process(self, customer_name: str, customer_email: str,
        ...
        category in {"fiction", "textbook", "children", "comic"}
        """
